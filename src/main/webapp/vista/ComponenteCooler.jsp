<%-- 
    Document   : ComponenteCooler
    Created on : 13 jun. 2024, 13:00:53
...
<html>
    ...
    <body>
        <div class="container mt-5">
            <div class="row">
                <c:forEach var="p" items="${Cooler}">
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            <img src="${pageContext.request.contextPath}/img/${p.getImagen()}" class="card-img-top" alt="MemoriaRAM">
