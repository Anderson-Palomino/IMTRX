                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body text-center">
                                ...
                                <a href="SVProductos?accion=AgregarCarrito&id=${p.idProducto}&tipo=Mouse" class="btn btn-outline-info">Añadir al carrito</a>
                                <a href="SVProductos?accion=Comprar&id=${p.idProducto}&tipo=Mouse" class="btn btn-danger">Comprar</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
